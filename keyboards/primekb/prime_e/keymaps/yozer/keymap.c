...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT(KC_ESC, KC_PPLS, KC_PMNS, KC_P7, KC_P8, KC_P9, KC_HOME, KC_END, KC_PGUP, KC_PGDN, KC_F22, KC_F23, KC_F24, KC_TRNS, KC_PAST, KC_PSLS, KC_P4, KC_P5, KC_P6, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_VOLU, KC_QUOT, KC_TRNS, KC_CIRC, KC_DOT, KC_P1, KC_P2, KC_P3, KC_TRNS, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_TRNS, KC_TRNS, KC_BSPC, KC_TRNS, KC_P0, KC_DEL, KC_TRNS, KC_TRNS, KC_TRNS)
};
